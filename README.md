...
- **Establishing reference ranges** - Create a standard set of normative ranges of features across various ages, genders, microphone types, and dialects labeled with health information. <em>These are provided as [tables and scripts](tba) in this repository</em>.
...
- **Creating machine learning models** - From Voiceome Study dataset, build and optimize novel machine learning models; to publish this work in academic journals openly. <em>These models will be published on in follow-on publications from this first publication.</em>
